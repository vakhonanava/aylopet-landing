...
export const PRODUCTS_KA: ProductsCopy = {
  ai: {
    title: "AylopetAI · თქვენი ძაღლის პერსონალური ციფრული ნუტრიციოლოგი",
    body: "ეს არის სპეციალიზირებული ხელოვნური ინტელექტი, რომლის ცოდნა სრულად არის კონცენტრირებული ძაღლის კვებაზე. საერთაშორისო დონის პროფესიონალ ნუტრიციოლოგების მიერ შემუშავებული სისტემა გაძლევთ საშუალებას მხოლოდ 60 წამში მიიღოთ სამეცნიერულად დამტკიცებული, ინდივიდუალური კვების გეგმა და რჩევები. AylopetAI ხელმისაწვდომია 24/7 თქვენი მეგობრის ჯანმრთელობის დასაცავად.",
    metrics: [
  ...
  freshFood: {
    title: "ძაღლის ცოცხალი საკვები: კვების ევოლუცია შენი მეგობრისთვის",
    subheading:
      "აღმოაჩინე ნაზად მომზადებული რაციონის ძალა და სიმართლე, რომელსაც მშრალი საკვების მწარმოებლები არ გეუბნებიან.",
    paragraph1:
      "ჩვენ გვჯერა, რომ ნამდვილი სიცოცხლისუნარიანობა მხოლოდ ბუნებრივი, დაუმუშავებელი საკვებიდან მოდის. Aylopet-ის რაციონი, რომელიც მზადდება ნაზი დამუშავების (Gently Cooked) მეთოდით, არის ევოლუციური ხიდი ველურ ინსტინქტებსა და თანამედროვე უსაფრთხოებას შორის. ჩვენ შევქმნათ ფორმულა, სადაც თქვენს ოთხფეხა მეგობარს აღარ უწევს არჩევანის გაკეთება ცოცხალ კვებასა და უსაფრთხოებას შორის.",
    paragraph2:
      "ჩვენი დაბალტემპერატურული პასტერიზაციის (70-დან 75°C-მდე) მეთოდით, ჩვენ სრულად ვანადგურებთ მავნე პათოგენებს, თუმცა ცოცხლად ვინარჩუნებთ იმ სასიცოცხლო ფერმენტებს, ნუტრიენტებსა და ამინომჟავებს, რომლებიც მხოლოდ ნედლ ხორცშია. ეს სწორედ ის კომპონენტებია, რომლებიც მაღალტემპერატურული თერმული დამუშავებისას (200°C-ზე ხარშვის ან გამოცხობისას) მომენტალურად ნადგურდება.",
    whyAylopet:
      "ჩვენ არ ვაწარმოებთ „ძაღლის საჭმელს“, ჩვენ პროდუქტს უსაფრთხო ცოცხალ საკვებად ვაქცევთ. შედეგად, თქვენი მეგობარი იღებს ბიოლოგიურად აქტიურ რაციონს ყოველგვარი ხელოვნური დანამატების, სინთეზური კონსერვანტების, ფარული შაქრებისა და გემოს გამაძლიერებლების გარეშე. ჩვენ გთავაზობთ იმას, რასაც მშრალი საკვების მწარმოებლები არ გეუბნებიან: ნამდვილ ხორცს სინთეზური ვიტამინების ნაცვლად.",
