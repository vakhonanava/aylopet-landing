...
export const ABOUT_KA: AboutCopy = {
  ...
  process: {
    ...
    pasteurizationNote:
      "ეს არის დაბალი ტემპერატურის თერმული დამუშავების მეთოდი, რომლის დროსაც ხორცი 75-80°C-ზე ჩერდება პასტერიზაციის ღუმელში 1 სთ. მისი მიზანია მავნე ბაქტერიების სრული განადგურება (სალმონელა, ლისტერია, ე. კოლი). ეს პროცესი სრულად ანადგურებს მავნე ბაქტერიებს, თუმცა ინარჩუნებს ხორცის ყველა სასარგებლო თვისებას: ამინომჟავებს, ვიტამინებს, მინერალებსა და კოლაგენს. შედეგად ვიღებთ უსაფრთხო, ნოყიერ და წვნიან საკვებს.",
  },
  team: {
    title: "ჩვენი გუნდი",
...
export const ABOUT_EN: AboutCopy = {
  ...
  process: {
    ...
    pasteurizationNote:
      "This is a low-temperature thermal processing method, where the meat is held at 75-80°C in the pasteurization chamber for 1 hour. Its purpose is to fully eliminate harmful bacteria (Salmonella, Listeria, E. coli). This process fully destroys harmful bacteria while preserving every beneficial property of the meat: amino acids, vitamins, minerals, and collagen. The result is safe, nutrient-rich, and moist food.",
  },
  team: {
    title: "Our team",
    status: "Coming soon",
