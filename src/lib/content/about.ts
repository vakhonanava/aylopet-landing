...
export const ABOUT_KA: AboutCopy = {
  ...
  vision: {
    ...
    body: "ჩვენი ხედვაა დავამკვიდროთ ცხოველთა მოვლისა და კეთილდღეობის ახალი, უმაღლესი სტანდარტი, სადაც მოწინავე ტექნოლოგიები და პერსონალიზებული ზრუნვა სრულ ჰარმონიაშია.\nჩვენ მივისწრაფვით შევქმნათ მომავალი, სადაც ოთხფეხა ოჯახის წევრები იღებენ ზუსტად მათზე მორგებულ, ყოვლისმომცველ ყურადღებას, ინდივიდუალურ მონაცემებზე დამყარებული კვებიდან და ყოველდღიური მზრუნველობიდან დაწყებული, დაავადებების ადრეული პრევენციით დამთავრებული. ეს მათ საშუალებას მისცემს, სრულად გამოავლინონ საკუთარი გენეტიკური შესაძლებლობები და გაატარონ უფრო მეტი, ხარისხიანი და ჯანსაღი წელი ჩვენს გვერდით.\nჩვენი მიზანია, მონაცემებზე დამყარებული ინოვაციური მეცნიერება ვაქციოთ ყოველდღიურ რეალობად მათთვის, ვისთვისაც ოთხფეხა მეგობრების ჯანმრთელობაში კომპრომისი არ არსებობს.",
  },
  values: [
    {
