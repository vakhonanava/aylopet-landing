...
const COPY = {
  ka: {
    ...
    chatBody:
      "უპასუხე რამდენიმე ძირითად შეკითხვას შენი ოთხფეხა მეგობრის შესახებ, AylopetAI კი მყისიერად დააგენერირებს პერსონალიზებულ რაციონს, რომელიც აკმაყოფილებს საერთაშორისო სტანდარტებს.",
    benefits: [
      {
        icon: MessageCircle,
