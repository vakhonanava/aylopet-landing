...
const COPY = {
  ka: {
    ...
    chatTitle: "რამდენიმე მარტივი შეკითხვა = პერსონალურ გეგმას",
    chatBody:
      "უპასუხე რამდენიმე ძირითად შეკითხვას შენი ოთხფეხა მეგობრის შესახებ, AylopetAI კი მყისიერად დააგენერირებს პერსონალიზირებულ რაციონს, რომელიც აკმაყოფილებს საერთაშორისო სტანდარტებს.",
    benefits: [
      {
        icon: MessageCircle,
        title: "ინტერაქტიული კონსულტაცია",
        body: "ცოცხალი დიალოგი და არა მკაცრი კითხვარი. დასვი კითხვები, გაუზიარე დეტალები და მიიღე პერსონალური რჩევები რეალურ დროში.",
      },
      {
        icon: Clock3,
        title: "კვების გეგმა წუთებში",
