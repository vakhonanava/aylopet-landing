...
const COPY = {
  ka: {
    ...
    ingredientsTitle: "ნამდვილი ხილი და ბოსტნეული, არა ფხვნილები",
    ingredientsDescription:
      "ყოველი წვეთი და ბოჭკო ჩვენს რაციონში იწყება ცოცხალი, სეზონური ინგრედიენტებით. არავითარი სინთეზური დანამატი არ ცვლის ბუნებრივ საკვებ ღირებულებას.",
