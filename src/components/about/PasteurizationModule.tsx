...
const METHOD_DESCRIPTIONS: Record<Locale, Record<ProcessingMethod, string>> = {
  ka: {
    ...
    aylopet: "75-80°C, 1 საათი, პათოგენების განადგურება სტრუქტურის შენარჩუნებით.",
  },
  en: {
    ...
    aylopet: "75 to 80°C for 1 hour, eliminating pathogens while preserving structure.",
  },
};
...
const COPY = {
  ka: {
    ...
    intro:
      "დაბალტემპერატურული თერმული დამუშავება (75-80°C, 1 საათი) სრულად ანადგურებს პათოგენებს სტრუქტურული ნუტრიენტების დაკარგვის გარეშე.",
  ...
  en: {
    ...
    intro:
      "Low-temperature thermal processing (75 to 80°C, 1 hour) delivers complete pathogen destruction without sacrificing structural nutrients.",
